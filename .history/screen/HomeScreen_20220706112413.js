...
const HomeScreen = () => {
  ...
  return (
    <SafeAreaView style={styles.homeScreen}>
      ...
      {/*Icons */}
      <View
        style={tw`w-full flex flex-row justify-around pt-2 bg-transparent text-blue-800`}
      >
        <Icon name="home" type="fontawesome" size={25} color="blue" />
        <Icon name="graduation-cap" type="fontawesome" size={25} color="blue" />
        <Icon name="book" type="fontawesome" size={25} color="blue" />
        <Icon name="info" type="fontawesome" size={25} color="blue" />
        <Icon name="user-circle-o" type="fontawesome" size={25} color="blue" />
        <Icon name="navicon" type="fontawesome" size={25} color="blue" />
      </View>
      <View
